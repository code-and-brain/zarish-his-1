...
import (
	...
	"zarish-his/backend/internal/service/integration"
)

type BillingHandler struct {
	service *integration.BillingService
}

func NewBillingHandler(service *integration.BillingService) *BillingHandler {
